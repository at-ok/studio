...
import { MapPin, Star, Clock, User, Camera, MessageSquare, Send, ThumbsUp, Lightbulb, Loader2, AlertTriangle, CheckCircle, ImagePlus } from 'lucide-react';
...
type Comment = typeof mockRouteDetail.comments[0];
...
export default function RouteDetailPage() {
  ...
  // In a real app, you'd fetch route data based on routeId.
  const route = mockRouteDetail;
  ...
  const [currentComments, setCurrentComments] = useState<Comment[]>(route.comments);
  ...
  useEffect(() => {
    // Simulate route data loading
    const timer = setTimeout(() => setIsLoadingRoute(false), 500);
  ...
  const handleCommentSubmit = (e: FormEvent) => {
    ...
    const newCommentEntry: Comment = {
      id: `c${currentComments.length + 3}`, // mock ID
    ...
    <div className="space-y-8">
      ...
      <Card className="overflow-hidden rounded-xl shadow-lg">
        <div className="relative h-64 md:h-96">
          <Image src={route.imageUrl} alt={route.title} layout="fill" objectFit="cover" data-ai-hint={route.imageHint} />
        ...
        <CardContent className="p-6 md:p-8">
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="flex items-center text-foreground">
              ...
              <div>
                ...
                <p className="font-semibold">{route.rating} ({route.reviewsCount} reviews)</p>
              </div>
            </div>
            <div className="flex items-center text-foreground">
          ...
          <p className="text-foreground whitespace-pre-line leading-relaxed">{route.longDescription}</p>
        </CardContent>
      </Card>
            ...
            {currentComments.map((comment) => (
              <div key={comment.id} className="flex items-start space-x-3">
                <Avatar className="h-10 w-10">
                  <AvatarImage src={comment.avatarUrl} alt={comment.user} data-ai-hint={comment.avatarHint}/>
      ...
      {/* Simulated end-of-route "演出" (effect) */}
      {/* This could be a modal triggered by some logic (e.g. GPS check or button press) */}
      {/* Example:
        <AlertDialog open={showEndOfRouteEffect}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-center">
                You've completed the {route.title}! We hope you enjoyed the journey.
                <br/>Don't forget to share your photos and feedback.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <Button onClick={() => setShowEndOfRouteEffect(false)}>Awesome!</Button>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      */}
